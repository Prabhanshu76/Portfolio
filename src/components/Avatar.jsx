...
export function Avatar(props) {
  ...
  const group = useRef();
  const { nodes, materials } = useGLTF("models/657a739d55e4a634b7e632c1.glb");
  ...
  useEffect(() => {
    ...
    if (actions[animation]) {
      ...
      console.error(`Animation at index ${animation} not found.`);
    }
  }, [animation, actions]);
...
useGLTF.preload("./public/models/657a739d55e4a634b7e632c1.glb");
